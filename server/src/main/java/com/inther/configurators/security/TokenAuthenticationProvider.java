package com.inther.configurators.security;
...
final class TokenAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    protected UserDetails retrieveUser(final String email, final UsernamePasswordAuthenticationToken authentication) {
        ...
        return Optional
                ...
                .orElseThrow(() -> new UsernameNotFoundException("Cannot find userEmail with authentication authentication token =" + token));
    }
}
